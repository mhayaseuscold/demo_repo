create or replace view CDW.TRANSFORM.LAWSON_FACT_EXPENSE_TRANSPOSE as
...
select plant_id, department, gl_company, account_unit, account, sub_account, fiscal_year, debit_month, expense_debit from CDW.TRANSFORM.lawson_fact_expense
...
select plant_id, department, gl_company, account_unit, account, sub_account, fiscal_year, credit_month, expense_credit from CDW.TRANSFORM.lawson_fact_expense
